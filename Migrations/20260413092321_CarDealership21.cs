...
{
    /// <inheritdoc />
    public partial class CarDealership21 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsClosedByUser = table.Column<bool>(type: "bit", nullable: false),
                    IsReadByUser = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
